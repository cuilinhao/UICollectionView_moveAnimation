...
@interface TestMainCollectionViewCell ()<UICollectionViewDelegate, UICollectionViewDataSource,TestCollectionViewCellDelegate>

@end

@implementation TestMainCollectionViewCell
...
{
    TestModel *sourceModel = (TestModel *)itemData;
    
    [self.dataArray addObject:sourceModel];
    [self.collectionView reloadData];
}
...
//    //用代理传送到 主页面
//    if ([self.delagte respondsToSelector:@selector(changeItem:)]) {
//        [self.delagte changeItem:sourceIndexPath];
//    }
//
